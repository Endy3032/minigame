				...
				{quizzes.map(quiz => (
					<div class="flex flex-col gap-3 w-full text-lg p-3 pb-5 border-2 border-zinc-700 bg-zinc-800 rounded-lg text-center transition-all">
						...
						<div className="flex flex-col md:flex-row gap-2">
							<a
								class="flex-1 border-2 rounded-md text-center transition-all p-4 hover:translate-y-1 hover:shadow-none shadow-[0_4px_0_0] border-zinc-400 shadow-zinc-400 active:bg-zinc-700 hover:bg-zinc-700/50"
								href={`/quiz/${quiz}`}
							>
								Làm Quiz
							</a>
